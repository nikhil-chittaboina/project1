...
ROOT_URLCONF = 'predicting_behavior_change_in_students.urls'
...
WSGI_APPLICATION = 'predicting_behavior_change_in_students.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predicting_behavior_change_in_students',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
