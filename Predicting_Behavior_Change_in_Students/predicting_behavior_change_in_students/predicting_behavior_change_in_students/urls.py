"""predicting_behavior_change_in_students URL Configuration
...
from predicting_behavior_change_in_students import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Student_Behavior_Change_Type/$', remoteuser.Predict_Student_Behavior_Change_Type, name="Predict_Student_Behavior_Change_Type"),
    ...
    url(r'^View_Student_Behavior_Type_Ratio/$', serviceprovider.View_Student_Behavior_Type_Ratio, name="View_Student_Behavior_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Student_Behavior_Type/$', serviceprovider.View_Prediction_Of_Student_Behavior_Type, name="View_Prediction_Of_Student_Behavior_Type"),
