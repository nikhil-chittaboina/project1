...
def View_Student_Behavior_Type_Ratio(request):
    ...
    return render(request, 'SProvider/View_Student_Behavior_Type_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Student_Behavior_Type(request):
    ...
    return render(request, 'SProvider/View_Prediction_Of_Student_Behavior_Type.html', {'list_objects': obj})
