...
--
-- Host: localhost
-- Generation Time: Aug 23, 2023 at 01:40 PM
...
--
-- Database: `predicting_behavior_change_in_students`
--
CREATE DATABASE IF NOT EXISTS `predicting_behavior_change_in_students` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_behavior_change_in_students`;
...
('2jp7o51fac84esrb46fdodpxvdcmwrsh', 'eyJ1c2VyaWQiOjJ9:1qWym2:QAWhkIJW0U1pDnUkB0KdlZ3ch85JqG7dHjg3eDGIiHo', '2023-09-01 12:40:18.889606'),
...
('vvkkguo0r9w94dobmelpwnv3b68k7qxr', 'eyJ1c2VyaWQiOjF9:1qWwuf:QZL1dwtom9hfJWuIyPpqikdy6p7Qh1cRxJ9rgk3PNp8', '2023-09-01 10:41:05.562379'),
...
(6, 'Deep Neural Network-DNN', '63.829787234042556'),
(7, 'SVM', '61.702127659574465'),
(8, 'Logistic Regression', '65.95744680851064'),
(9, 'Decision Tree Classifier', '55.319148936170215'),
(10, 'Extra Tree Classifier', '63.829787234042556');
...
--
-- Table structure for table `remote_user_predicting_behavior_change`
--

CREATE TABLE IF NOT EXISTS `remote_user_predicting_behavior_change` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `like_your_degree` varchar(3000) NOT NULL,
  ...
  `alcohol_consumption` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_predicting_behavior_change`
--

INSERT INTO `remote_user_predicting_behavior_change` (`id`, `Fid`, `Certification_Course`, `Gender`, `Department`, `Height_CM`, `Weight_KG`, `Tenth_Mark`, `Twelth_Mark`, `hobbies`, `daily_studing_time`, `prefer_to_study_in`, `like_your_degree`, `social_medai_video`, `Travelling_Time`, `Stress_Level`, `Financial_Status`, `alcohol_consumption`, `part_time_job`, `Prediction`) VALUES
(1, '172.217.3.110-10.42.0.42-443-42249-17', 'No', 'Male', 'BCA', '190', '85', '88.2', '67.5', 'Video Games', '0 - 30 minute', 'Morning', 'Yes', '1.30 - 2 hour', '1 - 1.30 hour', 'Bad', 'Bad', 'no', 'No', 'Good'),
(2, '10.42.0.151-72.30.3.43-41443-443-6', 'Yes', 'Female', 'BCA', '109', '42', '60', '70', 'Cinema', '30 - 60 minute', 'Anytime', 'Yes', '1 - 30 Minute', '30 - 60 minutes', 'Good', 'good', 'yes', 'No', 'Bad'),
(3, '172.217.10.14-10.42.0.151-443-56146-6', 'No', 'Male', 'BCA', '151', '69', '73', '85', 'Sports', '0 - 30 minute', 'Morning', 'Yes', '1 - 1.30 hour', '30 - 60 minutes', 'Good', 'good', 'no', 'No', 'Good'),
(4, '172.217.11.36-10.42.0.42-443-52963-6', 'Yes', 'Female', 'Commerce', '152', '60', '93.6', '85', 'Sports', '1 - 2 Hour', 'Anytime', 'Yes', '1 - 30 Minute', '0 - 30 minutes', 'Good', 'good', 'yes', 'No', 'Bad');
